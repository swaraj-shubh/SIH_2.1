...
const PatentDropdownCard = ({ patent }) => {
    ...
    return (
        <Card className="border-blue-200 hover:border-blue-300 transition-all">
            ...
            {/* Expandable Content */}
            {isExpanded && (
                <CardContent className="pt-0 space-y-4 border-t border-blue-200">
                    {/* Abstract */}
                    <div>
                            ...
                            <div className="space-y-2">
                                {applicants.map((applicant, index) => (
                                    <div key={index} className="text-blue-600 text-sm">
                                        ...
                                        {applicant.residence && (
                                            <div className="text-xs text-blue-500">Residence: {applicant.residence}</div>
                                        )}
                                        {applicant.extracted_address && (
                                            <div className="text-xs text-blue-500">{applicant.extracted_address}</div>
                                        )}
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="space-y-2">
                                {inventors.map((inventor, index) => (
                                    <div key={index} className="text-blue-600 text-sm">
                                        ...
                                        {inventor.residence && (
                                            <div className="text-xs text-blue-500">Residence: {inventor.residence}</div>
                                        )}
                                        {inventor.extracted_address && (
                                            <div className="text-xs text-blue-500">{inventor.extracted_address}</div>
                                        )}
                                    </div>
                                ))}
                            </div>
                                ...
                                {agents.map((agent, index) => (
                                    <div key={index} className="text-blue-600 text-sm">
                                        ...
                                        {agent.extracted_address && (
                                            <div className="text-xs text-blue-500">{agent.extracted_address}</div>
                                        )}
                                    </div>
                                ))}
                            </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-blue-900 mb-3 transform -skew-x-6">
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    <TabsList className="grid w-full grid-cols-4 bg-blue-100 p-1">
                        ...
                        <TabsTrigger value="patents" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white">
                        ...
                        <Card className="border-blue-200">
                            ...
                            <CardContent>
                                {patents.length > 0 ? (
                                    <div className="grid gap-4">
                                        {patents.slice(0, 3).map((patent, index) => {
                                            ...
                                            return (
                                                <div key={index} className="p-4 border border-blue-200 rounded-lg bg-white">
                                ...
                                <Button 
                                    ...
                                    variant="outline" 
                                    className="w-full mt-4 border-blue-300 text-blue-700"
                                >
                                    View All Patents
                                </Button>
                            </CardContent>
...
<TabsContent value="patents" className="space-y-6">
    ...
    {/* Patents Grid */}
    {loading ? (
        <Card className="text-center p-8 border-blue-200 bg-blue-50">
            <CardContent>
            ...
            <CardContent>
                ...
                {!searchTerm && (
                    ...
                    <TabsContent value="analysis">
                        <Card className="border-blue-200">
                            <CardHeader>
                                <CardTitle className="text-blue-900">Patent Analysis</CardTitle>
                                <CardDescription className="text-blue-700">
                            ...
                            <CardContent className="space-y-6">
                                {patents.length > 0 ? (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <Card className="border-blue-200 bg-blue-50">
                                            <CardHeader>
                                                <CardTitle className="text-blue-900 text-lg">Jurisdiction Distribution</CardTitle>
                                            </CardHeader>
                                            <CardContent>
                                                <div className="space-y-2">
                                        ...
                                        <Card className="border-blue-200 bg-blue-50">
                                            <CardHeader>
                                                <CardTitle className="text-blue-900 text-lg">Top Applicants</CardTitle>
                                            </CardHeader>
                                            <CardContent>
                                                <div className="space-y-2">
                                                    {(() => {
                                                        ...
                                                        return Object.entries(applicantCount)
                                                            ...
                                                            .map(([applicant, count]) => (
                                                                <div key={applicant} className="flex justify-between items-center">
                                                                    <span className="text-blue-700 text-sm truncate" title={applicant}>
                                                                        {applicant}
                                                                    </span>
                                                                    <Badge variant="secondary" className="bg-blue-100 text-blue-800">
                                                                        {count}
                    ...
                    <TabsContent value="export">
                        <Card className="border-blue-200">
                            <CardHeader>
                                <CardTitle className="text-blue-900">Export & Download</CardTitle>
                                <CardDescription className="text-blue-700">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                                    <h4 className="font-semibold text-blue-800 mb-2">Current Data Info</h4>

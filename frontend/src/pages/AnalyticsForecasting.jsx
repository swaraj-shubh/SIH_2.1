  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {error && (
          <div className="bg-red-900/40 border border-red-700 rounded-lg p-4 mb-6 flex items-center gap-2 backdrop-blur-sm">
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
            <div className="max-w-7xl mx-auto px-4 py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-slate-800/40 backdrop-blur-sm p-4 rounded-lg border border-blue-800/30 animate-pulse">
              ...
              {/* Tabs Skeleton */}
              <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg border border-blue-800/30 mb-6">
                <div className="border-b border-blue-800/30 flex overflow-x-auto">
                  {[...Array(6)].map((_, i) => (
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="h-64 bg-slate-700 rounded mb-4 animate-pulse"></div>
                      <div className="p-4 bg-slate-800/40 rounded backdrop-blur-sm">
                        <div className="h-4 w-20 bg-slate-700 rounded mb-2 animate-pulse"></div>
                        <div className="space-y-2">
                          {[...Array(3)].map((_, i) => (
                            <div key={i} className="flex items-start gap-2">
                              <div className="h-4 w-4 bg-slate-700 rounded mt-0.5 animate-pulse"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      {[...Array(2)].map((_, i) => (
                        <div key={i}>
                          ...
                          <div className="h-64 bg-slate-700 rounded mb-2 animate-pulse"></div>
                          <div className="h-3 w-full bg-slate-700 rounded animate-pulse"></div>
                        </div>
                      ))}
                    </div>
        ...
        {data && (
          <>
            <OverviewCards data={data} topic={topic} />
            ...
            <ExportActions data={data} topic={topic} />
          </>
        )}
      </div>
    </div>
